            ...
            <h6 className='md:text-3xl sm:text-2xl font-light '>Selecciona segun tus preferencias</h6>
                  ...
                  <div className='flex content-center items-center justify-center w-full m-6  '>
                      <label className='' > 
                        ...
                        <label className='ml-40 items-center' >
                          <span>Servicio</span>
                          <br />
                        <select className='form-select text-center mt-4  w-96 cursor-pointer'>
                            {
                  ...
                  <div className='flex flex-col text-xl font-medium text-center'>
                        <h3 className='pt-4 '> Selecciona el horario de tu preferencia</h3>
                         <label className='p-2 cursor-pointer '> <input type="radio" className='form-radio checked:bg-lime-900 checked:bg-lime-900 ' name="radio-btn" /> 08:00 </label> 
                         <label className='p-2 cursor-pointer'> <input type="radio" className='form-radio checked:bg-lime-900 checked:bg-lime-900' name="radio-btn" /> 09:00 </label> 
                         <label className='p-2 cursor-pointer'> <input type="radio" className='form-radio checked:bg-lime-900 checked:bg-lime-900' name="radio-btn"/> 10:00</label> 
                         <button className=' text-center border-2 border-black rounded-md hover:bg-black hover:text-lime-500 hover:p-4 duration-500 mt-12'> Realizar reserva</button>
                  </div>
                 </form>           
